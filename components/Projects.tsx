    ...
    scrollbar-track-gray-400/20  scrollbar-thumb-[#f7ab0a]'>
            {
                projects.map((project, i) => (
                    <div key={i} className='w-screen flex-shrink-0 snap-center flex flex-col space-y-5 items-center justify-center p-20 md:p-44 h-screen'>
                        ...
                        src="https://sinotov-developer-portfolio.netlify.app/static/media/weather_app.9343912a18eea4ed463c.png" alt=""/>
                            ...
                            <h4 className='text-4xl font-semibold text-center'>
                                <span className='underline decoration-[#f7ab0a] '>Case Study {i + 1} of {projects.length}: </span>
                                 ...
                                 <p className='text-lg text-center md:text-left'>
                                    ...
                                    Facilis assumenda delectus, animi ipsa incidunt veniam porro 
                                    voluptatem architecto quasi quo? Sapiente, porro! Ea vitae fuga 
                                    alias atque aspernatur nobis vel.
                                 </p>
                        </div>
                    </div>
                ))
        ...
        <div className='w-full absolute top=[30%] bg-[#f7ab0a]/10 lef-0 h-[500px] -skew-y-12'></div>
        </motion.div>
  )
}
