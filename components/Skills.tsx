...
const Skills = ({skills}: Props) => {
  return (
    ...
    className='flex relative flex-col text-center md:text-left xl:flex-row max-w-[2000px] xl:px-10 min-h-screen mx-auto items-center justify-center  xl:space-y-0'>
     <h3 className='absolute top-24 uppercase tracking-[20px] text-gray-500 text-2xl '>Навыки</h3>
     <h3 className='absolute top-36 uppercase tracking-[3px] text-gray-500 text-sm '>примерный уровень навыка по клику</h3>
